...
import org.firstinspires.ftc.teamcode.Experimental.Vision.Vision;
...
public class IMU {
    ...
    public IMU(double startTheta, LinearOpMode op){
        ...
        theta = startTheta;
        lastHeading = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZXY, AngleUnit.RADIANS).firstAngle;
    }
